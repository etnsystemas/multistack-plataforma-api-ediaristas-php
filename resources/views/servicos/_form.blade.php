            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->valor_minimo ?? '' }}" type="text" class="form-control" name="valor_minimo" id="valor_minimo"  placeholder="Valor mínimo do serviço">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="quantidade_horas">Quantidade Mínima de horas</label>
                        <input value="{{ $servico->quantidade_horas ?? '' }}" type="text" class="form-control" name="quantidade_horas" id="quantidade_horas"  placeholder="Quantidade mínima de horas">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="porcentagem">Porcentagem de Comissão</label>
                        <input value="{{ $servico->porcentagem ?? '' }}" type="text" class="form-control" name="porcentagem" id="porcentagem"  placeholder="porcentagem de comissão no serviço">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_quarto ?? '' }}" type="text" class="form-control" name="horas_quarto" id="horas_quarto"  placeholder="Quantidade horas por quarto">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_sala ?? '' }}" type="text" class="form-control" name="horas_sala" id="horas_sala"  placeholder="Quantidade horas por sala">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_banheiro ?? '' }}" type="text" class="form-control" name="horas_banheiro" id="horas_banheiro"  placeholder="Quantidade horas por banheiro">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_cozinha ?? '' }}" type="text" class="form-control" name="horas_cozinha" id="horas_cozinha"  placeholder="Quantidade horas por cozinha">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_quintal ?? '' }}" type="text" class="form-control" name="horas_quintal" id="horas_quintal"  placeholder="Quantidade horas por quintal">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $servico->horas_outros ?? '' }}" type="text" class="form-control" name="horas_outros" id="horas_outros"  placeholder="Quantidade horas por outros">
                    </div>
                </div>
            </div>
        </fieldset>
